...
function renderSocial() {
  ...
  const networks = [
    ...
    {
      name: isEn ? "WhatsApp Channel" : "Chaîne WhatsApp",
      handle: "M.G.N CodeWave",
      desc: isEn
        ? "Our announcements, tips and new projects — delivered straight to WhatsApp. No reply needed."
        : "Nos annonces, conseils et nouveaux projets, directement dans WhatsApp. Sans rien avoir à répondre.",
      url: "https://www.whatsapp.com/channel/0029VbCGslI5K3zaxdqRoX3U",
      color: "#128C7E",
      bg: "rgba(18,140,126,0.08)",
      icon: `<svg width="28" height="28" fill="currentColor" viewBox="0 0 24 24"><path d="M20 3.5c0-.93-1.05-1.47-1.8-.93L10.68 8H6a3 3 0 0 0-3 3v2a3 3 0 0 0 3 3h.35l1.7 5.36a1 1 0 0 0 .95.7h2.1a1 1 0 0 0 .95-1.32L10.6 16h.08l7.52 5.43c.75.54 1.8 0 1.8-.93V3.5z"/></svg>`,
      cta: isEn ? "Follow the channel" : "Suivre la chaîne",
      badge: isEn ? "News" : "Actualités",
    },
    {
      name: "GitHub",
    ...
    },
    {
      ...
      url: "https://www.linkedin.com/company/mgn-codewave/",
      color: "#0077b5",
